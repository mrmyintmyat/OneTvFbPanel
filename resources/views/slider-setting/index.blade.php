                                            ...
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                <li class="nav-item d-flex" role="presentation">
                                                    <button onclick="changeInput('img_url_{{ $index + 1 }}', 'file')"
                                                        ...
                                                        aria-selected="{{ !filter_var($imageUrl->img_url, FILTER_VALIDATE_URL) ? 'true' : 'false' }}">Upload
                                                        Logo</button>
                                                    <button onclick="changeInput('img_url_{{ $index + 1 }}', 'url')"
